...
export const optimizationRecommendations = [
  { id: 1, category: 'Right-Sizing', severity: 'High', description: 'Instance "prod-gpt4-xl" is underutilized (avg 20% CPU) and can be downsized to save an estimated $250/month.' },
  { id: 2, category: 'Subscription Plan', severity: 'High', description: 'Your current "Pay-as-you-go" plan for OpenAI API is not cost-effective. A committed use plan could save up to 30%.' },
  { id: 3, category: 'Caching', severity: 'Medium', description: 'Enable caching for "Project Beta" endpoints to reduce redundant API calls by an estimated 40%.' },
  { id: 4, category: 'Model Selection', severity: 'Medium', description: 'Consider using "GPT-3.5-turbo" instead of "GPT-4" for non-critical summarization tasks in "Project Gamma" to lower costs.' },
  { id: 5, category: 'Data Transfer', severity: 'Low', description: 'Data transfer costs for "Project Alpha" to "us-east-1" are slightly elevated. Review data locality.' },
  { id: 6, category: 'Logging', severity: 'Low', description: 'Verbose logging is enabled on "dev-claude-instance", increasing storage costs. Consider setting log level to "WARN".' }
];

export const modelEfficiencyRankings = [
  { model: 'Google Gemini Pro', costPerMillionTokens: '$0.50', avgLatency: '150ms', successRate: '99.5%' },
  { model: 'Anthropic Claude 3 Sonnet', costPerMillionTokens: '$0.65', avgLatency: '180ms', successRate: '99.2%' },
  { model: 'OpenAI GPT-3.5-Turbo', costPerMillionTokens: '$1.50', avgLatency: '250ms', successRate: '98.9%' },
  { model: 'OpenAI GPT-4', costPerMillionTokens: '$10.00', avgLatency: '500ms', successRate: '99.8%' }
];
